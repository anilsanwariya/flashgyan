...
export const Route = createFileRoute("/mcq-tests")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Take timed multiple-choice tests and review your score." },
    ],
  }),
    ...
    <div className="min-h-dvh bg-background/50 relative selection:bg-primary/20">
      ...
      <main className="px-5 max-w-2xl mx-auto pb-12 space-y-6 pt-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div>
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-foreground/90 drop-shadow-sm">MCQ Tests</h1>
